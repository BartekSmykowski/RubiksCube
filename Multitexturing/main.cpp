...
int main(int argc, char **argv) {
	...
	//multitexSphere->SetTexture("BaseTexture", SOIL_load_OGL_texture("Textures\\hehe.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_TEXTURE_REPEATS));
	//multitexSphere->SetTexture("SecondTexture", SOIL_load_OGL_texture("Textures\\hehe.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_TEXTURE_REPEATS));
	//multitexSphere->SetTexture("ThirdTexture", SOIL_load_OGL_texture("Textures\\hehe.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_TEXTURE_REPEATS));
	//multitexSphere->SetTexture("AlphaChanTexture", SOIL_load_OGL_texture("Textures\\hehe.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_TEXTURE_REPEATS));
	//multitexSphere->SetTexture("RampTexture", SOIL_load_OGL_texture("Textures\\hehe.bmp", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_TEXTURE_REPEATS));
